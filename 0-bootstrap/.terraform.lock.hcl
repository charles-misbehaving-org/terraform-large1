...
provider "registry.terraform.io/hashicorp/google" {
  version     = "4.84.0"
  constraints = ">= 2.12.0, >= 3.30.0, >= 3.43.0, >= 3.45.0, >= 3.50.0, >= 3.53.0, >= 3.67.0, >= 3.77.0, >= 3.83.0, >= 4.17.0, ~> 4.28, != 4.31.0, >= 4.42.0, < 5.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "4.84.0"
  constraints = ">= 3.30.0, >= 3.43.0, >= 3.45.0, >= 3.50.0, >= 3.67.0, >= 3.77.0, ~> 4.11, >= 4.17.0, ~> 4.28, != 4.31.0, < 5.0.0"
  hashes = [
